...
{
    private const string ENCRYPTION_KEY = "burningcarrotstudio";

    public static void SetString(string key, string value)
    {
        string encryptedValue = Encrypt(value, ENCRYPTION_KEY);
    ...
    public static string GetString(string key)
    {
        ...
        return string.IsNullOrEmpty(encryptedValue) ? string.Empty : Decrypt(encryptedValue, ENCRYPTION_KEY);
    }
